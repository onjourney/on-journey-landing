<template>
    <div>
        <div class="p-10">
            ...
            <div v-if="step != stepLength">
                <h1 class="text-2xl mb-4">
                    <span class="font-extrabold"> Register </span> Local Transport
                </h1>
        ...
        <transition name="fade" mode="out-in">
            <ModalVerify v-if="isModalActive" registration="local-transport" />
        </transition>
    </div>
</template>
    ...
    methods: {
        ...
        async submit() {
            ...
            try {
                ...
                await this.$store.dispatch("register/localTransport/register", this.formData);
            } catch (error) {
                Swal.fire({
                    title: 'Error!',
